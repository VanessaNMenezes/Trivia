...
let res1= document.querySelector('div#res1') 
    ...
    if(document.getElementById('abacaxi').checked) {  
        res1.innerText='Você acertou !! O abacaxi é uma planta vinda da América tropical, cultivada em muitas regiões quentes, é originário da América do Sul; mais especificamente, da região sul do Brasil.'       
        res1.style.color= '#1A936F' 
        
        document.getElementById("gif").innerHTML="<img src='minions.gif' width=300 >" 
        ponto= ponto+1
